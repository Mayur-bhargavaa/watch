      ...
      <div className="flex-1 flex flex-col h-screen overflow-y-auto px-4 sm:px-8 py-6 space-y-6">
        ...
        {showAvatarModal && (
          <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-3 sm:p-5">
            <div className="bg-white dark:bg-[#181922] border border-slate-200 dark:border-white/10 rounded-3xl w-full max-w-5xl shadow-2xl flex flex-col" style={{ maxHeight: '95vh' }}>
              {/* Header */}
              <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-slate-100 dark:border-white/[0.07] shrink-0">
                <div>
                  <h3 className="text-base font-black text-slate-900 dark:text-white">Customize Your Bitmoji</h3>
                  <p className="text-[11px] text-slate-400 dark:text-zinc-400 mt-0.5">All changes reflect instantly · Select any option to apply</p>
                </div>
                <button
                  type="button"
              ...
              {/* Footer */}
              <div className="flex justify-end gap-2 px-6 py-4 border-t border-slate-100 dark:border-white/[0.07] shrink-0">
                <button
                  type="button"
                  onClick={() => setShowAvatarModal(false)}
                ...
                <button
                  ...
                  className="px-5 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-black shadow transition flex items-center gap-1.5"
                >
