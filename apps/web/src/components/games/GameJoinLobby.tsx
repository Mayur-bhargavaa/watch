...
export const GameJoinLobby: React.FC<GameJoinLobbyProps> = ({
  ...
  return (
    <div className="w-full min-h-[calc(100vh-4rem)] flex flex-col justify-between relative z-10 select-none px-6 sm:px-10 lg:px-14 py-4 sm:py-6 overflow-hidden bg-[#0c0d12] text-white">
      {/* Top Header Bar (Unified Ludo Navbar) */}
      <header className="w-full max-w-7xl mx-auto flex items-center justify-between pb-4 border-b border-white/[0.08]">
        <div className="flex items-center gap-3">
          ...
          <div className="text-xs sm:text-sm font-semibold tracking-tight text-zinc-400">
            <span>Watch.</span> <span className="text-zinc-600">/</span> <span>Game Lobby</span> <span className="text-zinc-600">/</span> <span className="text-[#ee1d49] font-bold">{titlePrimary} {titleSecondary}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={toggleTheme}
            className="w-9 h-9 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 flex items-center justify-center text-amber-400 transition cursor-pointer"
            title="Toggle theme"
          >
          ...
          {rulesContent && (
            <button
              ...
              className="w-9 h-9 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 flex items-center justify-center text-zinc-300 hover:text-white transition cursor-pointer"
      ...
      {/* Main Hero Container */}
      <div className="w-full flex-1 flex items-center max-w-7xl mx-auto my-auto py-6 sm:py-8">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight leading-none mb-3 sm:mb-4">
              ...
              <span className="text-white">{titleSecondary}</span>
            </h1>

            {/* Subtitle */}
            <p className="text-xs sm:text-sm lg:text-base font-medium max-w-lg leading-relaxed mb-4 sm:mb-5 text-zinc-400">
              {description}
            ...
            {/* Error Banner */}
            {lobbyError && (
              <div className="mb-4 p-3 bg-rose-950/60 border border-rose-500/40 text-rose-300 rounded-2xl text-xs font-semibold">
                {lobbyError}
              </div>
            )}

            {/* Container: Play with Connected Person (Exact Ludo theme) */}
            {partner ? (
              <div className="mb-4 sm:mb-5 rounded-[22px] sm:rounded-[26px] p-3.5 sm:p-4.5 max-w-xl bg-[#18121f]/90 border border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="relative shrink-0">
                      ...
                      <span className="absolute -bottom-0.5 -right-0.5 flex h-3 w-3 items-center justify-center rounded-full bg-[#0c0d12]">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="p-2 sm:p-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-rose-300 transition shadow-xs cursor-pointer active:scale-95 disabled:opacity-50"
                    >
                ...
                {partnerPingStatus && (
                  <div className="mt-2.5 pt-2 border-t border-white/10 text-[11px] font-medium text-rose-400 flex items-center gap-1.5">
                    <span>{partnerPingStatus}</span>
                  </div>
                )}
              </div>
            ) : (
              <div className="mb-4 sm:mb-5 rounded-[22px] sm:rounded-[26px] p-3.5 sm:p-4 max-w-xl bg-[#18121f]/90 border border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
                {!showPartnerConnectInput ? (
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full flex items-center justify-center text-[#ee1d49] bg-rose-500/15 shrink-0">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <button
                        ...
                        className="py-2 px-2.5 rounded-xl border border-white/10 text-zinc-300 hover:bg-white/5 text-xs font-semibold transition cursor-pointer"
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs font-bold text-white">Connect with your Partner</span>
                      </div>
                      <button
                        type="button"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                      {myPartnerCode && (
                        <div className="flex items-center justify-between p-2 rounded-xl border bg-white/5 border-white/10">
                          <div className="min-w-0">
                          ...
                          <button
                            ...
                            className="px-2 py-1 font-medium text-[10px] rounded-lg bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 transition cursor-pointer"
                          >
                      ...
                      <form onSubmit={handleConnectPartner} className="flex gap-1.5">
                        <input
                          ...
                          className="flex-1 min-w-0 px-2.5 py-1.5 rounded-xl text-xs font-mono uppercase bg-black/40 border border-white/10 text-white placeholder-zinc-500 focus:outline-none focus:border-[#ee1d49]"
                        />
                        <button
                          type="submit"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 max-w-xl">
              ...
              <div className="rounded-[24px] sm:rounded-[28px] p-5 sm:p-6 flex flex-col justify-between transition-all bg-[#18121f]/90 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] hover:border-white/20">
                <div>
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full flex items-center justify-center mb-4 sm:mb-5 bg-rose-500/15 border border-rose-500/30 text-rose-400">
                    <Users className="w-4 h-4 sm:w-5 sm:h-5 fill-current" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold tracking-tight mb-1.5 text-white">
                    Create a Room
                  </h3>
                  <p className="text-xs sm:text-[13px] font-normal leading-relaxed mb-5 sm:mb-6 text-zinc-400">
              ...
              {/* Card 2: Join a Room */}
              <div className="rounded-[24px] sm:rounded-[28px] p-5 sm:p-6 flex flex-col justify-between transition-all bg-[#121626]/90 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] hover:border-white/20">
                <div>
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full flex items-center justify-center mb-4 sm:mb-5 bg-blue-500/15 border border-blue-500/30 text-blue-400">
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative">
            <div className="relative w-full max-w-[340px] sm:max-w-[400px] lg:max-w-[460px] max-h-[50vh] aspect-square flex items-center justify-center">
              {rightGraphic || (
                <div className="w-full h-full rounded-3xl bg-gradient-to-tr from-rose-500/10 via-purple-500/10 to-transparent border border-white/10 flex flex-col items-center justify-center p-8 text-center shadow-2xl relative">
                  <Sparkles className="w-16 h-16 text-[#ee1d49] animate-pulse mb-3" />
                  <span className="text-2xl font-black text-white">{titlePrimary} {titleSecondary}</span>
                  <span className="text-xs text-zinc-400 mt-2">Real-time 2-Player Private Arena</span>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="w-full max-w-7xl mx-auto pt-2 pb-1 flex flex-col sm:flex-row items-center justify-between gap-4 relative z-10 shrink-0 border-t border-white/[0.05]">
        <div className="flex items-center">
          <img
            src="/images/ludo-flourish-dark.png"
            alt="Good Games, Brighter Friendships"
            className="h-14 sm:h-18 lg:h-20 w-auto object-contain select-none pointer-events-none"
          />
        </div>

        <div className="text-[10px] sm:text-[11px] font-bold tracking-[0.3em] uppercase text-zinc-500">
          PLAY • CONNECT • REPEAT
        </div>
      </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#14151b] border border-white/15 rounded-[28px] p-6 sm:p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in-95 duration-150 relative text-white">
            <button
              type="button"
              onClick={() => setShowCreateModal(false)}
              className="absolute top-5 right-5 p-2 rounded-full hover:bg-white/10 text-zinc-400 hover:text-white transition cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="space-y-4">
              ...
              {partner && (
                <div className="p-3.5 border border-rose-500/20 bg-rose-500/10 rounded-2xl flex items-center justify-between text-rose-200">
            ...
            <form onSubmit={handleJoinByCode} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  maxLength={20}
                  className="w-full bg-black/50 border border-white/15 focus:border-[#185df2] rounded-2xl px-4 py-3 text-center font-mono text-base font-bold text-white placeholder-zinc-500 uppercase tracking-widest outline-none transition"
                  autoFocus
                />
              </div>
      ...
      {showRulesModal && rulesContent && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#14151b] border border-white/15 rounded-[28px] p-6 sm:p-8 max-w-lg w-full shadow-2xl animate-in fade-in zoom-in-95 duration-150 relative text-white max-h-[85vh] overflow-y-auto">
            <button
              type="button"
