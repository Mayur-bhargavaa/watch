...
import { Mic, MicOff, Video, VideoOff, MessageCircle, Smile, Settings } from 'lucide-react';

interface BingoBottomDockProps {
  isMuted: boolean;
  isCameraOn: boolean;
...
export const BingoBottomDock: React.FC<BingoBottomDockProps> = ({
  isMuted,
  isCameraOn,
  unreadChatCount = 0,
  onToggleMic,
